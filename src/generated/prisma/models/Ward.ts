...
export type WardWhereInput = {
  ...
  code?: Prisma.IntFilter<"Ward"> | number
  name?: Prisma.StringFilter<"Ward"> | string
  provinceCode?: Prisma.IntFilter<"Ward"> | number
...
export type WardScalarWhereWithAggregatesInput = {
  ...
  code?: Prisma.IntWithAggregatesFilter<"Ward"> | number
  name?: Prisma.StringWithAggregatesFilter<"Ward"> | string
  provinceCode?: Prisma.IntWithAggregatesFilter<"Ward"> | number
}
...
export type WardOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"code" | "name" | "provinceCode", ExtArgs["result"]["ward"]>
...
export interface WardDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const wardWithCodeOnly = await prisma.ward.findMany({ select: { code: true } })
   * 
   */
   ...
   * const wardWithCodeOnly = await prisma.ward.createManyAndReturn({
   *   select: { code: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const wardWithCodeOnly = await prisma.ward.updateManyAndReturn({
   *   select: { code: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface WardFieldRefs {
  readonly code: Prisma.FieldRef<"Ward", 'Int'>
  readonly name: Prisma.FieldRef<"Ward", 'String'>
  readonly provinceCode: Prisma.FieldRef<"Ward", 'Int'>
}
